...
assert.match(music, /Reproducción tipo navegador en segundo plano/);
assert.match(music, /Mantener música en segundo plano/);
assert.match(music, /Bloquear anuncios del reproductor/);
assert.match(music, /Bloquear enlaces externos/);
assert.match(music, /Mezcla con la voz/);
...
assert.match(sounds, /Biblioteca incluida/);
assert.match(sounds, /BUILTIN_SOUNDS/);
assert.match(sounds, /Bajar música durante alertas/);

const soundLibrary = read('src/services/soundLibrary.ts');
assert.match(soundLibrary, /Campanita cute/);
assert.match(soundLibrary, /Brillo mágico/);
assert.match(soundLibrary, /Celebración/);
assert.match(soundLibrary, /installBuiltinSound/);
assert.match(soundLibrary, /initializeBuiltinSoundDefaults/);
