...
assert lock["version"] == "1.1.6"
assert lock["packages"][""]["version"] == "1.1.6"
...
assert 'id="versionLabel">v1.1.6' in html
assert 'id="updateVersionBadge">v1.1.6' in html
assert "## 1.1.6" in read("CHANGELOG.md")
...
print(
    f"Lulu Finity 1.1.6 validada: {len(audit.ids)} IDs únicos, editor propio, "
