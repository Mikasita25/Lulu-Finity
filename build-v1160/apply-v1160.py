...
SOURCE_HASHES = {
    ...
    "src/preload.js": "18a3461fb80c58a5423f685356590e7ace2eb4b9c30239f6a922b0257b7c0a52",
...
if package.get("version") != "1.1.1":
    raise SystemExit(f"Lulu Finity 1.1.6 espera la fuente 1.1.1, no {package.get('version')}")
...
if updated.get("version") != "1.1.6":
    raise SystemExit("El parche no produjo package.json 1.1.6")

print("Lulu Finity 1.1.6 reconstruida sobre la fuente oficial 1.1.1")
