...
if package.get("version") != "1.1.1":
    raise SystemExit(f"Lulu Finity 1.1.5 espera la fuente 1.1.1, no {package.get('version')}")
...
if updated.get("version") != "1.1.5":
    raise SystemExit("El parche no produjo package.json 1.1.5")

print("Lulu Finity 1.1.5 reconstruida sobre la fuente oficial 1.1.1")
