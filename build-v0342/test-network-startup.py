...
assert '<span class="version" id="versionLabel">v0.34.2</span>' in (root/'src/index.html').read_text(encoding='utf-8')
print('Pruebas de arranque sin red 0.34.2: OK')
