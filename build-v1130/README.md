# Parche reproducible de Lulu Finity 1.1.3

Este directorio transforma el ZIP oficial `Lulu-Finity-Source-1.1.1.zip` en la fuente 1.1.3. `apply-v1130.py` valida la versión y el SHA-256 de cada archivo base antes de copiar el payload.
...
```bash
python build-v1130/apply-v1130.py app
python build-v1130/test-v1130.py app
```
