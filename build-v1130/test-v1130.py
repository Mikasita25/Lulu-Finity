...
assert lock["version"] == "1.1.3"
assert lock["packages"][""]["version"] == "1.1.3"
assert 'id="versionLabel">v1.1.3' in html
assert 'id="updateVersionBadge">v1.1.3' in html
assert "## 1.1.3" in read("CHANGELOG.md")
...
print(
    f"Lulu Finity 1.1.3 validada: {len(audit.ids)} IDs únicos, editor propio, "
