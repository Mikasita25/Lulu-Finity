...
replacements = {
    'assert package["version"] == "1.0.2"': 'assert package["version"] == "1.0.3"',
    'assert lock["version"] == "1.0.2"': 'assert lock["version"] == "1.0.3"',
    'assert lock["packages"][""]["version"] == "1.0.2"': 'assert lock["packages"][""]["version"] == "1.0.3"',
    "assert 'id=\"versionLabel\">v1.0.2' in html": "assert 'id=\"versionLabel\">v1.0.3' in html",
    "assert 'id=\"updateVersionBadge\">v1.0.2' in html": "assert 'id=\"updateVersionBadge\">v1.0.3' in html",
