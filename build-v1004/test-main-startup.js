...
autoUpdater.checkForUpdates = async () => ({ updateInfo: { version: '1.0.4' } });
...
(async () => {
  try {
    ...
    assert.equal(initial.version, '1.0.4');
    ...
    console.log(`Arranque 1.0.4 validado: ${ipcHandlers.size} handlers, ${pageModules.size + 3} páginas con ciclo exclusivo y navegación lista`);
  } finally {
