# Parche reproducible de Lulu Finity 1.1.4

Este directorio transforma el ZIP oficial `Lulu-Finity-Source-1.1.1.zip` en la fuente 1.1.4. `apply-v1140.py` valida la versión y el SHA-256 de cada archivo base antes de copiar el payload.
...
```bash
python build-v1140/apply-v1140.py app
python build-v1140/test-v1140.py app
```
